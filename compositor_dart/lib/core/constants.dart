import 'package:material_ui/material_ui.dart' show PageController;
...
const int pointerPanZoomStartEvent = 9;
const int pointerPanZoomUpdateEvent = 10;
const int pointerPanZoomEndEvent = 11;
const int pointerCancelEvent = 12;

const int pointerKindMouse = 1;
const int pointerKindTouch = 2;
const int pointerKindUnknown = 3;
const int pointerKindTrackpad = 4;
...
class CustomPageController extends PageController {
  ...
  set viewportFraction(double value) {
    ...
    if (oldPage != null) {
      (position as dynamic).viewportDimension = value;
    }
  }
}
