#ifndef NONSTD_WLROOTS_H
#define NONSTD_WLROOTS_H
...
/**
 * This file is used to put all wlroots headers needed in the Compositor API in an extern "C" block because
 * wlroots headers are not always compatible with C++.
 */
extern "C" {
    struct wlr_backend;
    struct wlr_renderer;
...
// This needs to be done because access to the `wlr_egl` instance is normally
// not available from the renderer. We instead create the egl instance +
// renderer manually.
