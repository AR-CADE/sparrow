#ifndef NONSTD_WLROOTS_FULL_H
#define NONSTD_WLROOTS_FULL_H

/**
 * This file is used to put all wlroots headers needed in the Compositor (not only API) in an extern "C" block
 * because wlroots headers are not always compatible with C++.
 *
 * Note that some wlroots headers require generated protocol header files. There are disabled unless the
 * protocol header file is present.
 */
#include <sparrow/nonstd/wlroots.hpp>
